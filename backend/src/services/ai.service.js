...
========================= */
export const transcribeAudioBase64 = async (audioBase64) => {
    try {
...
/* =========================
   CHAT RESPONSE
========================= */
export const getAiChatResponse = async (transcript, history = [], previousContext = "", isPastBedtime = false, currentTimeStr = "", userBedtime = "22:00") => {
    try {
        const systemPromptText = transcript === "[SILENCE]"
...
export const getFinalSessionSummary = async (conversationText) => {
    try {
        const summaryPrompt = `
...
export const generateAudioFromText = async (text, voiceSetting = 'Tessa (Momy)', voiceProvider = 'Cartesia') => {
